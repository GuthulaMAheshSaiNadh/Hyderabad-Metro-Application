	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public static void Create_Metro_Map(Graph_M g)
		{
			g.addVertex("miyapur");
                        ...
                        g.addVertex("Bharath nager");
                        g.addVertex("Ameerpit");
                        g.addVertex("khairathbad");
                        g.addVertex("Nampally");
                        g.addVertex("Osmania medical college");
                        g.addVertex("MGBS");
                        g.addVertex("Dilsuknager");
                        g.addVertex("L.B Nager");
                        g.addVertex("Raidurg");
                        g.addVertex("Hitech City");
                        g.addVertex("Jubliee Hills check post");
                        g.addVertex("Paradise");
                        g.addVertex("JBS");
                        g.addVertex("Secunderabad east");
                        g.addVertex("Tarnaka");
                        g.addVertex("Nagole");
                        
			
			g.addEdge("miyapur", "Kukatpally", 1);
                        g.addEdge("Kukatpally", "Bharath nager", 1);
                        g.addEdge("Bharath nager", "Ameerpit", 1);
                        g.addEdge("Ameerpit", "khairathbad", 3);
                        g.addEdge("Ameerpit", "khairathbad", 3);
